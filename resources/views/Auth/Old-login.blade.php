                    ...
                    <div class="col-12 col-md-9 col-lg-7 col-xl-6 col-xxl-5">
                        <div class="card border border-light-subtle rounded-4">
                            <div class="card-body p-3 p-md-4 p-xl-5">
                                    ...
                                    <div class="row gy-3 overflow-hidden">
                                        ...
                                        <div class="col-12">
                                            <div class="form-floating mb-1">
                                                ...
                                                <i class="bi bi-eye-slash" style="position: absolute;right: 10px;top: 60%;transform: translateY(-60%);cursor: pointer;" id="togglePassword"></i>
                                            </div>

                                            <a href="{{ route('forget-password') }}"
                                                class="link-secondary text-decoration-none text-end d-flex justify-content-end">Forgot
                                                password?</a>
                                        </div>
                                        <div class="col-12">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="d-flex  mt-2 justify-content-center">
                                            <span>Do not have account?</span><a href="{{ route('register') }}"
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <p class="my-3 mt-1 text-center">Or continue with</p>
