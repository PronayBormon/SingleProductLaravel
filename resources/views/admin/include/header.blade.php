<header class="topbar">
    <nav class="navbar top-navbar navbar-expand-md navbar-dark">
        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="{{url('/')}}">
                <!-- Logo icon --><b>
                    ...
                    <!-- Dark Logo icon -->
                    <img src="/logo.png" alt="homepage" class="dark-logo w-100" />
                    <!-- Light Logo icon -->
                    <img src="/logo.png" alt="homepage" class="light-logo w-100" />
                </b>
                <!--End Logo icon -->
                <!-- Logo text --><span>
                 <!-- dark Logo text -->
                 ...
                 <!-- Light Logo text -->    
                 <img src="/logo.png" class="light-logo" alt="homepage" /></span> </a> --}}
        </div>
        <!-- ============================================================== -->
        <!-- End Logo -->
        <!-- ============================================================== -->
        <div class="navbar-collapse">
            ...
            <!-- ============================================================== -->
            <ul class="navbar-nav my-lg-0 d-none">
                <!-- ============================================================== -->
                <!-- Comment -->
                <!-- ============================================================== -->
