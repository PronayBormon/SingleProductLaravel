    ...
    <div class="scroll-sidebar">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu animated flipInY">
                        ...
                        <form action="{{ route('logout') }}" method="POST" id="logout-form">
                            @csrf
                            <button type="submit" class="p-2 border-0 m-0 dropdown-item bg-transparent">Logout</button>
                        </form>
                        <!-- text-->
                    </div>
                </div>
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li>
                    <a class="waves-effect waves-dark" href="{{ url('/admin/products') }}">
                        <i class="fa-solid fa-box"></i>
                        <span class="hide-menu">Products </span>
                    </a>
                </li>
                <li>
                    <a class="waves-effect waves-dark" href="{{ url('/admin/orders') }}">
                        <i class="fa-solid fa-box"></i>
...
{{-- 
                ...
                <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i
                            class="ti-palette"></i><span class="hide-menu">Ui Elements <span
                                class="badge rounded-pill bg-primary text-white ms-auto">25</span></span></a>
                    <ul aria-expanded="false" class="collapse">
